...
J'ai les numéros 13 à 20.\
Il me manque les numéros 1 à 12 et le dernier numéro (celui avec le programme star trek (de David H. Ahl).

### Correctif

Le No 19 est disponible ici car absent des DataBases.\
J'ai refait le scan et il est dispo ici en attendant d'être uploader sur [Abandonware Magazines](https://abandonware-magazines.org/).
...
Chaque numéros dispose de son Markdown propre.
Veuillez les consulter pour plus d'informations.
