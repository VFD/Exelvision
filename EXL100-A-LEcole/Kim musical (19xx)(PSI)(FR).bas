...
140 L=50
150 JEU=0
160 DIM N(7),CO$(7),NOM$(7),NT$(7),D(7)
170 FOR I=1 TO 7
180 READ N(I),CO$(I),NOM$(I)
190 NEXT I
200 DATA 199,1RC,DO,176,1BC,RE,158,1bC,MI,149,1RC,FA
210 DATA 133,1RC,SOL,118,1BC,LA,105,1WC,SI
220 !PRESENTATION
230 CLS "BCC"
240 CALL COLOR("0BYLH"):LOCATE (4,8):PRINT"KKIIMM MMUUSSIICCAALL"
250 LOCATE (5,8):PRINT "KKIIMMMMUUSSIICCAALL"
260 CALL COLOR("0BC"):LOCATE (10,8):PRINT "TU VAS D'ABORD ENTENDRE LA GAMME"
270 PRINT:PRINT "ENSUITE TU ENTENDRAS UN MORCEA U DE 6":PRINT
280 PRINT "NOTES,PUIS LE MEME MORCEAU MAIS AVEC UNE":PRINT
290 PRINT "NOTE EN MOINS."
300 CALL COLOR("0bC"):PRINT:PRINT "A TOI DE RETROUVER CETTE NOTE"
...
670 LOCATE (19,1):PRINT RPT$(" ",40);"NON,C'EST ENCORE FAUX."
...
780 PRINT "MAINTENANT TU VAS JOUER SANS LIRE LE NOM DES NOTES."
790 PAUSE 10
800 GOTO 370
810 CLS "CBB"
820 CALL COLOR("0RBHL"):FOR I=6 TO 7:LOCATE (I,12)
...
1000 FOR I=1 TO 7
1010 LOCATE (17-I,4*I+1):CALL COLOR(CO$(I)):PRINT "A":CALL COLOR("0BC")
1020 LOCATE (18,I*4+1):PRINT NOM$(I)
