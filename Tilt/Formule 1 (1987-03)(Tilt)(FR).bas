...
7 !      ****DECLARATIONS***
8 !
9 MT$="0E68D2CD031EF040043CE0010F78C0021BB040042C60010F5840031AD08008FE"
10 EX$="0BA02163031B1800BD1E133840073A108100F0801EB1080480478F0844200205 "
11 EX$=EX$&"70CEBD02110840704E118840043CE0010F7BC00316B080052C200108488002"
12 EX$=EX$&"14A000052B"
13 CALL POKE(50920,162,5,45,162,136,45,10):CALL EXEC(50920)
14 FU=73:D=18
15 DIM Z$(6),P$(9),M$(6),C$(6)
16 C$(1)="C":C$(2)="R":C$(3)="M":C$(4)="Y":C$(5)="G":C$(6)="b"
17 MO$="C72030C7031EF040043CE0010F7BC00216B040042C60010F5840031AD08006FE"
18 VO$=" "&CHR$(120)&CHR$(121)&CHR$(122)&CHR$(123)&" "
19 VP$=" "&CHR$(124)&CHRt(121)&CHR$(122)&CHR$(123)&" "
20 CHOC=0
21 RANDOMIZE
22 X=20
23 !
24 !      ****GRAPHISMES****
25 !
26 CALL CHAR(32,"FFFFFFFFFFFFFFFFFFFF")
...
34 CALL CHAR(40,"000000F898F8DB000000")
...
48 CALL CHAR(103,"3838383838000000787B")
49 CALL CHAR(104,"78787878787878000000")
50 CALL CHAR(105,"00F8FBFBF8F8FBF8F8F8")
...
58 CALL CHAR(124,"FF007CB282B2FE82827C")
...
93 FOR I=6 TO 10
94 CALL COLOR("OCC">:LOCATE (I,1):PRINT RPT$(" ",40)
95 NEXT I
96 FOR I=11 TO 16
97 IF DEPART=1 AND I=16 THEN GOTO 101
...
146 IF I=15 THEN CALL COLOR("1GW"):GOSUB 164:GOTO 151
...
154 !
155 HA=INTRND(5)
156 CALL COLOR ("OGG"):LOCATE (11,24-(I-7)):PRINT " "
...
186 CALL LINE("8",FUE,171,FUE,191)
187 RETURN
188 !
188 !      ****CHOCS****
190 !
...
201 !
202 T=T+.3
203 CALL LINE("G",30,193-T,142,193-T)
...
214 CALL COLOR("ORW"):LOCATE (22,30):PRINT "PRESS KEY"
...
223 LOCATE (11,17):PRINT RPT$(CHR$(62),8):CALL COLOR("OBW"):PAUSE .2
...
232 CALL COLOR("0BWL"):LOCATE (12,15):PRINT "DDEEPPARRTT"
...
233 LOCATE (14,13):PRINT RPT$(CHR$(32),16)
240 LOCATE (15,13>:PRINT" ":LOCATE (15,28):PRINT " "
241 LOCATE (16,13>:PRINT" ":LOCATE (16,28):PRINT " "
242 CALL COLOR("0BWLH"):LOCATE (12,15):PRINT "DDEEPPARRTT"
243 CALL SPEECH("L,"&MT$)
244 LOCATE (13,15):PRINT "DDEEPPARRTT"
245 CALL COLOR("OBY"):LOCATE (22,31): PRINT "PRESS KEY"
246 CALL COLOR("1WB"):LOCATE (16,20) :PRINT VO$
247 CALL SPEECH("L,"&MT$):PAUSE .4
248 LOCATE (16,20):PRINT VP$
243 CALL KEY1(A,B):IF B=0 THEN 246
250 CALL COLOR("1WB"):LOCATE (16,20):PRINT VO$
251 RETURN
252 !
253 !      ********************
